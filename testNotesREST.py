...
data = """{
    "note":"ыдловплыотавплдоывпалдоывталдоптывлдоатплдывоатплоы
            втаплоывалпотвыадлоптывщопывпафывпкаываплотиловапыв
            апывапвыапвыапывап",
     "description":"ыдловплыотавплдоывпалдоывталдоптывлдоатплдывоатплоывтаплоывалпотвыадлоптывщопывпафывпкаываплотилова
                    ...
                    оатплдывоатплоывтаплоывалпотвыадлоптывщопывпафывпкаываплотиловапывапывапвыапвыапывапыдловплыотавплд
                    оывпалдоывталдоптывлдоатплдывоатплоывтаплоывалпотвыадлоптывщопывпафывпкаываплотиловапывапывапвыапвы
                    апывапыдловплыотавплдоывпалдоывталдоптывлдоатплдывоатплоывтаплоывалпотвыадлоптывщопывпафывпкаывапло
                    тиловапывапывапвыапвыапывапыдловплыотавплдоывпалдоывталдоптывлдоатплдывоатплоывтаплоывалпотвыадлопт
                    ывщопывпафывпкаываплотиловапывапывапвыапвыапывапыдловплыотавплдоывпалдоывталдоптывлдоатплдывоатплоы
                    втаплоывалпотвыадлоптывщопывпафывпкаываплотиловапывапывапвыапвыапывапыдловплыотавплдоывпалдоывталдо
                    птывлдоатплдывоатплsdfsdfsdfsdfdsd"} """

errors = 0
print('port: ', end='')
HOST = '127.0.0.1:{}/notes/'.format(input())
available_ids = set()
